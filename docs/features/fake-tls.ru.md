...
Если совместить `-R` и `-D domain`, один и тот же listener будет принимать оба варианта:

- `ee...` Fake-TLS клиентов для указанного домена
- `dd...` padded MTProto клиентов по raw transport
